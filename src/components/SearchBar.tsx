...
export default function SearchBar({
  ...
  return (
    ...
    `}
      ...
      aria-label="곡 검색"
    >
      <label htmlFor="song-search" className="sr-only">곡 검색</label>
      <div className={`
      ...
      `}>
        ...
        <input
          ...
          placeholder="곡 검색..."
          aria-label="곡 제목, 아티스트 또는 가사로 검색"
          className={`
      ...
      <div className="flex items-center gap-2" role="group" aria-label="필터 옵션">
        <button
        ...
        <button
          ...
          aria-pressed={showOnlyWithLyrics}
          aria-label="가사 있는 곡만 보기"
          className={`
            flex-1 py-2 rounded-lg text-sm font-medium transition-colors
            ${showOnlyWithLyrics
              ? isDarkMode
