            ...
            {popularSongs.slice(0, 3).map((song, index) => (
              ...
              >
                <div className="absolute inset-0">
                  <CachedImage
                    src={song.fileName ? getLocalFileUrl(song.fileName, 'image') : `/popular_img/${index + 1}.jpg`}
                    alt={song.title}
                    width={400}
                    height={400}
            ...
            {popularSongs.slice(3).map((song, index) => (
              ...
              >
                <div className="w-12 h-12 relative flex-shrink-0">
                  <CachedImage
                    src={song.fileName ? getLocalFileUrl(song.fileName, 'image') : `/popular_img/${index + 4}.jpg`}
                    alt={song.title}
                    width={48}
                    height={48}
